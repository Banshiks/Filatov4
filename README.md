# Домашнее задание к занятию 11.1 "`Базы данных, их типы`" - `Филатов Олег`
...
NewSQL-системы сочетают преимущества SQL и NoSQL, что позволяет им обрабатывать большие объёмы данных и выдерживать высокие нагрузки, сохраняя при этом целостность и согласованность данных, характерные для традиционных реляционных баз данных.
---
